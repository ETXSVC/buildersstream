  ...
  return (
    <div className="bg-neutral-light min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        <h1 className="text-4xl font-bold text-neutral-slate mb-4">Transparent Pricing</h1>
        <p className="text-xl text-neutral-gray text-neutral-500">No hidden fees. Cancel anytime.</p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        {tiers.map((tier) => (
            <div key={tier.name} className={`relative flex flex-col p-8 rounded-2xl border ${tier.primary ? 'border-primary shadow-2xl scale-105 z-10 bg-[#1e293b]' : 'border-neutral-800 bg-[#1e293b] shadow-sm hover:shadow-lg transition-shadow'}`}>
                {tier.primary && (
                ...
                <div className="text-5xl font-bold text-neutral-slate mb-6">{tier.price}<span className="text-lg font-medium text-neutral-400">/mo</span></div>
