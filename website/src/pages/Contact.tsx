    ...
    <div className="bg-neutral-light min-h-screen pt-24 pb-12 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            {/* Contact Info */}
            <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-neutral-slate mb-6">Let's Build Together</h1>
                <p className="text-lg sm:text-xl text-neutral-gray mb-8 sm:mb-12">
            ...
            {/* Form */}
            <div className="bg-[#1e293b] rounded-2xl shadow-xl p-5 sm:p-8 border border-neutral-800">
